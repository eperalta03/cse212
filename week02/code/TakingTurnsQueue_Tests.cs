...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: The Enqueue() function was inserting people at index 0 instead of at the end of the queue.
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: The method incorrectly modified the turns of players with infinite turns.
    ...
    // Defect(s) Found: The method decreased players with infinite turns instead of preserving their original turns.
