public class Translator
{
    ...
    private Dictionary<string, string> translatorTable = new();
    public void AddWord(string fromWord, string toWord)
    {
        translatorTable.Add(fromWord, toWord);
    }
    ...
    public string Translate(string fromWord)
    {
        ...
        if (translatorTable.ContainsKey(fromWord))
        {
            translateWord = translatorTable[fromWord];
        }
